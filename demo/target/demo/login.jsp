				...
				<%@ page import="model.User" %>
					...
					<body class="align">
						...
						<div class="grid">
							...
							<!-- 添加 action 参数 -->
							<form action="user?action=login" method="POST" class="form login">

								<!-- 显示错误信息 -->
								<% String error=request.getAttribute("error") !=null ? (String)
							...
							<p class="text--center">Not a member? <a href="./register.jsp">Sign up now</a> <svg
									class="icon">
